...
export function StepBasics({ profile, onSaveProfile, onNext }: Props) {
  ...
  return (
    <div className="nb-card">
      <h2 className="mb-1 text-[1.15rem] font-bold">Seus dados básicos</h2>
      <p className="mb-4 text-[0.84rem] text-[var(--text-soft)]">Usado para calcular sua TMB, GET e meta diária.</p>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-3">
        ...
        <button type="submit" disabled={saving} className="nb-btn nb-btn-primary mt-2 w-full py-2.5">
